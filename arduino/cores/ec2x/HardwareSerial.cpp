...
void HardwareSerial::config_port(void)
{
	...
	*/
	new_tty_attr.c_iflag = IGNPAR | ICRNL;

	/*
	OPOST	: Enable output processing
	ONLCR	: Ouput carriage retern added to new line
	*/
	new_tty_attr.c_oflag = OPOST | ONLCR;
...
{	
	...
	*/
	...
	case 500000: baudrate=B500000;
		break;
	case B576000: baudrate=B576000;
		break;
	case 921600: baudrate=B921600;
		break;
	case B1152000: baudrate=B1152000;
		break;
	case B1500000: baudrate=B1500000;
		break;
	case B2000000: baudrate=B2000000;
		break;
	case B2500000: baudrate=B2500000;
		break;
	case B3000000: baudrate=B3000000;
		break;
	case B3500000: baudrate=B3500000;
		break;
	case B4000000: baudrate=B4000000;
		break;
