...
//UART must be open in main task, callback is being processed in Ql_OS_GetMessage()
...
//ADC must be open in main task, callback is being processed in Ql_OS_GetMessage()
...
// BC66 OpenCPU have not system time API, this is fake time...
