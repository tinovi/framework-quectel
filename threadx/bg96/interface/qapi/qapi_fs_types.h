...
/*WizIO*/
#define ___QAPI_FS_ERROR(x)  ((qapi_Status_t)(__QAPI_ERROR(QAPI_MOD_BSP_FS,  x)))

#define QAPI_ERR_EPERM            ___QAPI_FS_ERROR(1)
                                        /* Operation is not permitted. */

#define QAPI_ERR_EBADF            ___QAPI_FS_ERROR(2)
                                        /* Bad file descriptor. */

#define QAPI_ERR_EACCES           ___QAPI_FS_ERROR(3)
                                        /* Permission denied. */

#define QAPI_ERR_EXDEV            ___QAPI_FS_ERROR(4)
                                        /* Attempt to cross the device. */

#define QAPI_ERR_ENODEV           ___QAPI_FS_ERROR(5)
                                        /* No such device. */

#define QAPI_ERR_ENOTDIR          ___QAPI_FS_ERROR(6)
                                        /* Not a directory. */

#define QAPI_ERR_EISDIR           ___QAPI_FS_ERROR(7)
                                        /* Is a directory. */ 

#define QAPI_ERR_EMFILE           ___QAPI_FS_ERROR(8)
                                        /* Too many open files. */

#define QAPI_ERR_ETXTBSY          ___QAPI_FS_ERROR(9)
                                        /* File or directory is already open. */

#define QAPI_ERR_ENOSPC           ___QAPI_FS_ERROR(10)
                                        /* No space is left on the device. */

#define QAPI_ERR_ESPIPE           ___QAPI_FS_ERROR(11)
                                        /* Seek is not permitted. */

#define QAPI_ERR_ENAMETOOLONG     ___QAPI_FS_ERROR(12)
                                        /* File name is too long. */

#define QAPI_ERR_ENOTEMPTY        ___QAPI_FS_ERROR(13)
                                        /* Directory is not empty. */

#define QAPI_ERR_ELOOP            ___QAPI_FS_ERROR(14)
                                        /* Too many symbolic links were encountered. */

#define QAPI_ERR_EILSEQ           ___QAPI_FS_ERROR(15)
                                        /* Illegal byte sequence. */

#define QAPI_ERR_ESTALE           ___QAPI_FS_ERROR(16)
                                        /* Stale remote file handle. */

#define QAPI_ERR_EDQUOT           ___QAPI_FS_ERROR(17)
                                        /* Attempt to write beyond the quota, */

#define QAPI_ERR_EEOF             ___QAPI_FS_ERROR(18)
                                        /* End of file. */

#define QAPI_ERR_INVLD_ID         ___QAPI_FS_ERROR(19)
                                        /* Invalid ID was passed by the kernel framework. */

#define QAPI_ERR_UNKNOWN          ___QAPI_FS_ERROR(20)
                                        /* Unknown error */
